...
exports.main = function(opts, callback) {
    ...
    var password = opts.password    || "rUstY3";
    var scheme   = opts.scheme      || "https";
    var host     = opts.host        || "luncher.us";
    ...
    Async.chain([
            ...
            function(success, done) {
                ...
                service.search("search sourcetype=irclogs source=tcp:514 | fields _raw, _time, host, index, source, sourcetype, action, from, names, nick, server, text, to, topic | head 3", {}, done);
            },
